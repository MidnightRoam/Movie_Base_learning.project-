# Generated by Django 3.2 on 2022-06-01 14:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career', models.CharField(blank=True, max_length=250, verbose_name='Career in the film industry')),
                ('height', models.FloatField(blank=True, verbose_name='Height')),
                ('genres', models.CharField(blank=True, max_length=250, verbose_name='Genres')),
                ('born_date', models.DateField(default=datetime.date.today, verbose_name='Date of born')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagline', models.CharField(default='', max_length=150, verbose_name='Tagline')),
                ('description', models.TextField(verbose_name='Description')),
                ...
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='specify the amount in dollars', verbose_name='Fees in USA')),
        ...
        migrations.AddField(
            model_name='movie',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.moviecategory', verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='movie',
            name='directors',
